...
public class Point3DImpl extends Point2DImpl implements Point3D{
	...
	public boolean equals(double x2, double y2, double z2){
		if (this.getX() == x2 && this.getY() == y2 && z == z2) {
			return true;
		} else {
			return false;
		}
	...
	public boolean equals(Object p){
		...
		return equals(point3D.getX(), point3D.getY(), point3D.getZ());
	...
	public double getDistance(double x2, double y2, double z2){
		...
		return sqrt(pow((this.getX() - x2), 2) + pow((this.getY() - y2), 2) + pow((this.z - z2), 2));
